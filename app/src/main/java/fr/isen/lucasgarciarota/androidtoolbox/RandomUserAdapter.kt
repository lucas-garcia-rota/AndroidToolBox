...
class RandomUserAdapter (private val items: RandomUser, val context: Context): RecyclerView.Adapter<RandomUserAdapter.ViewHolderRandom>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RandomUserAdapter.ViewHolderRandom {
        return ViewHolderRandom(LayoutInflater.from(context).inflate(R.layout.random_user_view, parent, false))
    }
